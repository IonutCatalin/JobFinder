					...
					<div className="row align-items-center pb-4">
						...
						<div className="col-md-6 offset-xl-1">
							<div className="d-flex align-items-center">
								<div
									className="card card-light card-body p-4 p-xl-5 my-2 my-md-0"
									style={{ maxWidth: "526px" }}
								>
									<div style={{ maxWidth: "380px" }}>
										<h3 className="h4 text-light">Download Our App</h3>
										<p className="fs-sm text-light opacity-70 mb-2 mb-lg-3">
											Now finding the new job just got even easier with our new
											app!
										</p>
										<div className="d-flex flex-column flex-sm-row">
											<a
												className="btn-market me-sm-3 mt-3"
												href="#"
												role="button"
											>
												<svg
											...
											<a className="btn-market mt-3" href="#" role="button">
												<svg
													xmlns="http://www.w3.org/2000/svg"
													width="140"
													height="34"
